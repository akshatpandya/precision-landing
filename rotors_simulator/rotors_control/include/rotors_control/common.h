...
//New
inline void windFromMsg(const rotors_comm::WindSpeedConstPtr& msg, EigenWind *wind_msg) {

  wind_msg->velocity = Eigen::Vector3d(msg->velocity.x, msg->velocity.y, msg->velocity.z);
}
